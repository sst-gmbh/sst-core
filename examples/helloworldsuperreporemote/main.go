...
// The main function of this file is to start the Super Remote Repository server.
// This file should be run by below command, parameters can be modified by specified application.
// Example:
//
//	go run examples/helloworldsuperreporemote/main.go --verbose --dir=./examples/helloworldsuperreporemote/testsstrepo/
package main
...
func main() {
	...
	s, err := sst.NewSuperServer(&config)
	if err != nil {
		return
	}
