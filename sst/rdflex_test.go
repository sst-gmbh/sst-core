...
var tokenName = map[tokenType]string{
	...
	tokenEOL:               "EOL",
	tokenEOF:               "EOF",
	tokenIRIAbs:            "RdfIRI (absolute)",
	tokenIRIRel:            "RdfIRI (relative)",
	tokenLiteral:           "RdfTypeLiteral",
	tokenLiteral3:          "RdfTypeLiteral (triple-quoted string)",
	tokenLiteralInteger:    "RdfTypeLiteral (integer shorthand syntax)",
	tokenLiteralDouble:     "RdfTypeLiteral (double shorthand syntax)",
	tokenLiteralDecimal:    "RdfTypeLiteral (decimal shorthand syntax)",
	tokenLiteralBoolean:    "RdfTypeLiteral (boolean shorthand syntax)",
	tokenBNode:             "Blank node",
	tokenLangMarker:        "Language tag marker",
	tokenLang:              "Language tag",
	tokenDataTypeMarker:    "RdfTypeLiteral datatype marker",
	tokenDot:               "Dot",
...
3'''`, []testToken{
	...
	`},
		...
		},
		{
			`"a"^`, []testToken{
				{tokenLiteral, "a"},
				{tokenError, "bad literal: invalid datatype RdfIRI"},
			},
		},
		{
			`"a"^^`, []testToken{
