...
<http://伝言.example#?user=أكرم&amp;channel=R%26D> a :subject8 . # a multi-script subject RdfIRI .`,
...
ns1:subject2	ns1:predicate2	ns1:object2 .
@prefix ns2:	<http://two.example#> .
ns2:subject3	ns2:predicate3	ns2:object3 .
@prefix ns3:	<http://伝言.example#> .
ns3:?user=أكرم&amp;channel=R%26D	a	ns0:subject8 .`,
...
ns0:218	ns1:label	"That Seventies Show" .`,
	...
	`@prefix ns0:	<http://example.org/elements#> .
@prefix ns1:	<http://en.wikipedia.org/wiki#> .
ns1:Helium	ns0:atomicMass	4.002602 ;
	ns0:atomicNumber	2 ;
	ns0:specificGravity	1.663E-4 .`,

	`@prefix ns0:	<http://example.org/stats#> .
@prefix ns1:	<http://somecountry.example#> .
ns1:census2007	ns0:isLandlocked	false .`,
...
_:c	ns0:name	"Eve" .`,
	...
	`@prefix rdf:	<http://www.w3.org/1999/02/22-rdf-syntax-ns#> .
@prefix ns0:	<http://example.org/foo#> .
ns0:subject	ns0:predicate2	rdf:nil ;
	ns0:predicate	_:b1 .
_:b1	rdf:first	ns0:a ;
	rdf:rest	_:b2 .
_:b2	rdf:first	ns0:b ;
	rdf:rest	_:b3 .
_:b3	rdf:first	ns0:c ;
	rdf:rest	rdf:nil .`,
...
func BenchmarkReadTTL(b *testing.B) {
	var bf bytes.Buffer
	...
	b.ResetTimer()
	for n := 0; n < b.N; n++ {
		dec := newTripleReader(bytes.NewReader(bf.Bytes()), RdfFormatTurtle)
		for _, err := dec.read(); err != io.EOF; _, err = dec.read() {
			if err != nil {
				b.Fatal(err)
			}
		}
...
func TestWritingTTL(t *testing.T) {
	t.Skip("due to output differences, this test is disabled")
	for i, ex := range ttlBenchInputs {
		dec := newTripleReader(bytes.NewBufferString(ex), RdfFormatTurtle)
		triples, err := dec.readAll()
		if err != nil {
			t.Fatal(err)
		}
		var buf bytes.Buffer
		enc := newTripleWriter(&buf, RdfFormatTurtle)

		// test custom namespace as well
		enc.Namespaces["http://www.w3.org/1999/02/22-rdf-syntax-ns"] = "rdf"

		err = enc.writeAll(triples)
		...
		if buf.String() != ttlBenchOutputs[i] {
			t.Fatalf("Read/write roundtrip failed, re-writing:\n%v\ngot:\n%v\nwant:\n%v", ex, buf.String(), ttlBenchOutputs[i])
		}
	}
}
...
func TestTTL(t *testing.T) {
	for _, test := range ttlTestSuite {
		dec := newTripleReader(bytes.NewBufferString(test.input), RdfFormatTurtle)
		triples, err := dec.readAll()
		if err != nil {
			if test.errWant == "" {
...
var ttlTestSuite = []struct {
	...
	//   mf:name      "IRI_subject" ;
	//   rdfs:comment "RdfIRI subject" ;
	//   rdft:approval rdft:Approved ;
	//   mf:action    <IRI_subject.ttl> ;
	//   mf:result    <IRI_spo.nt> ;
	//   .

	{`<http://a.example/s> <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		},
	}},

	//<#IRI_with_four_digit_numeric_escape> rdf:type rdft:TestTurtleEval ;
	//   mf:name      "IRI_with_four_digit_numeric_escape" ;
	//   rdfs:comment "RdfIRI with four digit numeric escape (\\u)" ;
	//   rdft:approval rdft:Approved ;
	...
	//   rdfs:comment "RdfIRI with eight digit numeric escape (\\U)" ;
	//   rdft:approval rdft:Approved ;
	//   mf:action    <IRI_with_eight_digit_numeric_escape.ttl> ;
	//   mf:result    <IRI_spo.nt> ;
	//   .

	{`<http://a.example/\U00000073> <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
	...
	//   rdfs:comment "RdfIRI with all punctuation" ;
	//   rdft:approval rdft:Approved ;
	//   mf:action    <IRI_with_all_punctuation.ttl> ;
	//   mf:result    <IRI_with_all_punctuation.nt> ;
	//   .

	{`<scheme:!$%25&amp;'()*+,-./0123456789:/@ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz~?#> <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI("scheme:!$%25&amp;'()*+,-./0123456789:/@ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz~?#"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		},
	}},
	...
	{`<http://a.example/s> a <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
...
p:s <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
...
p:s <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
	...
	//   rdfs:comment "prefixed RdfIRI predicate" ;
	//   rdft:approval rdft:Approved ;
	...
	{`@prefix p: <http://a.example/>.
<http://a.example/s> p:p <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
	...
	//   rdfs:comment "prefixed RdfIRI object" ;
	//   rdft:approval rdft:Approved ;
	...
	{`@prefix p: <http://a.example/>.
<http://a.example/s> <http://a.example/p> p:o .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
	...
	//   rdfs:comment "prefix-only RdfIRI (p:)" ;
	//   rdft:approval rdft:Approved ;
...
p: <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
...
<http://a.example/s> <http://a.example/p> AZazÀÖØöø˿ͰͽͿ῿‌‍⁰↏Ⰰ⿯、퟿豈﷏ﷰ�𐀀󯿽:o .`, //lint:ignore ST1018 for test
		"",
		[]rdfTriple{
			{
				Subj: IRI("http://a.example/s"),
...
a·̀ͯ‿.⁀:s <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
	...
	{`@prefix p: <http://a.example/> .
<http://a.example/s> <http://a.example/p> p:AZazÀÖØöø˿Ͱͽ΄῾‌‍⁰↉Ⰰ⿕、ퟻ﨎ﷇﷰ￯ .`, //lint:ignore ST1018 for test
		"", []rdfTriple{
			{
				Subj: IRI("http://a.example/s"),
				Pred: IRI("http://a.example/p"),
				Obj:  IRI("http://a.example/AZazÀÖØöø˿Ͱͽ΄῾‌‍⁰↉Ⰰ⿕、ퟻ﨎ﷇﷰ￯"), //lint:ignore ST1018 for test
			},
		}},
	...
	{`@prefix p: <http://a.example/> .
<http://a.example/s> <http://a.example/p> p:AZazÀÖØöø˿Ͱͽ΄῾‌‍⁰↉Ⰰ⿕、ퟻ﨎ﷇﷰ￯𐀀󠇯 .`, //lint:ignore ST1018 for test
		"", []rdfTriple{
			{
				Subj: IRI("http://a.example/s"),
				Pred: IRI("http://a.example/p"),
				Obj:  IRI("http://a.example/AZazÀÖØöø˿Ͱͽ΄῾‌‍⁰↉Ⰰ⿕、ퟻ﨎ﷇﷰ￯𐀀󠇯"), //lint:ignore ST1018 for test
			},
		}},
	...
	{`@prefix p: <http://a.example/> .
<http://a.example/s> <http://a.example/p> p:AZazÀÖØöø˿ͰͽͿ῿‌‍⁰↏Ⰰ⿯、퟿﨎﷏ﷰ￯𐀀󯿽 .`, //lint:ignore ST1018 for test
		"", []rdfTriple{
			{
				Subj: IRI("http://a.example/s"),
				Pred: IRI("http://a.example/p"),
				Obj:  IRI("http://a.example/AZazÀÖØöø˿ͰͽͿ῿‌‍⁰↏Ⰰ⿯、퟿﨎﷏ﷰ￯𐀀󯿽"), //lint:ignore ST1018 for test
			},
		}},

	//<#default_namespace_IRI> rdf:type rdft:TestTurtleEval ;
	//   mf:name      "default_namespace_IRI" ;
	//   rdfs:comment "default namespace RdfIRI (:ln)" ;
	//   rdft:approval rdft:Approved ;
...
:s <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
...
p:s <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
	...
	{`@prefix p: <http://a.example/>.
p:\_\~\.-\!\$\&\'\(\)\*\+\,\;\=\/\?\#\@\%00 <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI(`http://a.example/_~.-!$&'()*+,;=/?#@%00`),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		},
	}},
	...
	{`@prefix p: <http://a.example/>.
p:%25 <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI(`http://a.example/%25`),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		},
	}},
...
p:s- <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
	...
	{`@prefix p: <http://a.example/>.
p:s_ <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI(`http://a.example/s_`),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		},
	}},
...
p:s: <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
	...
	{`@prefix p: <http://a.example/>.
p:_ <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI(`http://a.example/_`),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		},
	}},
	...
	{`@prefix p: <http://a.example/>.
p:0 <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI(`http://a.example/0`),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		},
	}},
	...
	{`@prefix p: <http://a.example/>.
p:a·̀ͯ‿.⁀ <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: IRI(`http://a.example/a·̀ͯ‿.⁀`),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		},
	}},
...
<s> <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
	...
	{`_:s <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: rdfTypeBlank{id: "_:s"},
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> _:o .`, "", []rdfTriple{
		{
			Subj: IRI(`http://a.example/s`),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeBlank{id: "_:o"},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> _:AZazÀÖØöø˿ͰͽͿ῿‌‍⁰↏Ⰰ⿯、퟿豈﷏ﷰ�𐀀󯿽 .`, //lint:ignore ST1018 for test
		"", []rdfTriple{
			{
				Subj: IRI(`http://a.example/s`),
				Pred: IRI("http://a.example/p"),
				Obj:  rdfTypeBlank{id: "_:AZazÀÖØöø˿ͰͽͿ῿‌‍⁰↏Ⰰ⿯、퟿豈﷏ﷰ�𐀀󯿽"}, //lint:ignore ST1018 for test
			},
		}},
	...
	{`<http://a.example/s> <http://a.example/p> _:_ .`, "", []rdfTriple{
		{
			Subj: IRI(`http://a.example/s`),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeBlank{id: "_:_"},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> _:0 .`, "", []rdfTriple{
		{
			Subj: IRI(`http://a.example/s`),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeBlank{id: "_:0"},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> _:a·̀ͯ‿.⁀ .`, "", []rdfTriple{
		{
			Subj: IRI(`http://a.example/s`),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeBlank{id: "_:a·̀ͯ‿.⁀"},
		},
	}},
	...
	{`[] <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> [] .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeBlank{id: "_:b1"},
		},
	}},
	...
	{`[ <http://a.example/p> <http://a.example/o> ] <http://a.example/p2> <http://a.example/o2> .`, "", []rdfTriple{
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o"),
		...
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://a.example/p2"),
			Obj:  IRI("http://a.example/o2"),
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> [ <http://a.example/p2> <http://a.example/o2> ] .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeBlank{id: "_:b1"},
	...
	{`[ <http://a.example/p1> <http://a.example/o1> ; <http://a.example/p2> <http://a.example/o2> ] <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://a.example/p1"),
			Obj:  IRI("http://a.example/o1"),
		},
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://a.example/p2"),
	...
	{`[ <http://a.example/p1> [ <http://a.example/p2> <http://a.example/o2> ] ; <http://a.example/p> <http://a.example/o> ].`, "", []rdfTriple{
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://a.example/p1"),
			Obj:  rdfTypeBlank{id: "_:b2"},
		},
		{
			Subj: rdfTypeBlank{id: "_:b2"},
			Pred: IRI("http://a.example/p2"),
			Obj:  IRI("http://a.example/o2"),
		},
		{
	...
	{`[ <http://a.example/p1> (1) ] .`, "", []rdfTriple{
		...
		{
			Subj: rdfTypeBlank{id: "_:b2"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  rdfTypeLiteral{str: "1", DataType: xsdInteger},
		},
		{
			Subj: rdfTypeBlank{id: "_:b2"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest"),
			Obj:  IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#nil"),
		},
	}},
	...
	{`(1) <http://a.example/p> <http://a.example/o> .`, "", []rdfTriple{
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  rdfTypeLiteral{str: "1", DataType: xsdInteger},
	...
	{`<http://a.example/s> <http://a.example/p> (1) .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeBlank{id: "_:b1"},
	...
	{`<http://a.example/s> <http://a.example/p> ((1) 2) .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeBlank{id: "_:b1"},
		...
		},
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest"),
			Obj:  rdfTypeBlank{id: "_:b3"},
		},
		{
			Subj: rdfTypeBlank{id: "_:b3"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  rdfTypeLiteral{str: "2", DataType: xsdInteger},
		},
		{
			Subj: rdfTypeBlank{id: "_:b3"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest"),
	...
	{`<http://a.example/s> <http://a.example/p> 'x' .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "x", DataType: xsdString},
		},
	}},
	...
	{"<http://a.example/s> <http://a.example/p> '\x00	&([]' .",//lint:ignore ST1018 for test
	"", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "\u0000\t\u000B\u000C\u000E&([]\u007F", DataType: xsdString},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> '߿ࠀ࿿က쿿퀀퟿�𐀀𿿽񀀀󿿽􀀀􏿽' .`, //lint:ignore ST1018 for test
		"", []rdfTriple{
			{
				Subj: IRI("http://a.example/s"),
				Pred: IRI("http://a.example/p"),
				Obj:  rdfTypeLiteral{str: "߿ࠀ࿿က쿿퀀퟿�𐀀𿿽񀀀󿿽􀀀􏿽", DataType: xsdString}, //lint:ignore ST1018 for test
			},
		}},
	...
	{"<http://a.example/s> <http://a.example/p> ' !\"#$%&():;<=>?@[]^_`{|}~' .", "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: " !\"#$%&():;<=>?@[]^_`{|}~", DataType: xsdString},
		},
	}},
		...
		"", []rdfTriple{
			{
				Subj: IRI("http://a.example/s"),
				Pred: IRI("http://a.example/p"),
				Obj:  rdfTypeLiteral{str: "\x00&([]", DataType: xsdString}, //lint:ignore ST1018 for test
			},
		}},
	...
	{`<http://a.example/s> <http://a.example/p> '''x'y''' .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "x'y", DataType: xsdString},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> '' .`, //lint:ignore ST1018 for test
		"", []rdfTriple{
			{
				Subj: IRI("http://a.example/s"),
				Pred: IRI("http://a.example/p"),
				Obj:  rdfTypeLiteral{str: "", DataType: xsdString}, //lint:ignore ST1018 for test
			},
		}},
...
''' .`, "", []rdfTriple{
	...
	{"<http://a.example/s> <http://a.example/p> '''\r''' .", "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "\r", DataType: xsdString},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> '\b' .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "\b", DataType: xsdString},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> '\f' .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "\f", DataType: xsdString},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> '\u006F' .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "o", DataType: xsdString},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> '\U0000006F' .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "o", DataType: xsdString},
	...
	{`<http://a.example/s> <http://a.example/p> "1"^^<http://www.w3.org/2001/XMLSchema#integer> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "1", DataType: xsdInteger},
	...
	{`@prefix xsd: <http://www.w3.org/2001/XMLSchema#> .
<http://a.example/s> <http://a.example/p> "1"^^xsd:integer .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "1", DataType: xsdInteger},
	...
	{`<http://a.example/s> <http://a.example/p> 1.0 .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "1.0", DataType: xsdDecimal},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> 1E0 .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "1E0", DataType: xsdDouble},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> 01 .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "01", DataType: xsdInteger},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> true .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "true", DataType: xsdBoolean},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> false .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "false", DataType: xsdBoolean},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> "chat"@en .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "chat", lang: "en", DataType: rdfLangString},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> "chat"@en-us .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  rdfTypeLiteral{str: "chat", lang: "en-us", DataType: rdfLangString},
		},
	}},
	...
	{`<http://a.example/s> <http://a.example/p> <http://a.example/o1>, <http://a.example/o2> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o1"),
	...
	{`<http://a.example/s> <http://a.example/p1> <http://a.example/o1>; <http://a.example/p2> <http://a.example/o2> .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p1"),
			Obj:  IRI("http://a.example/o1"),
	...
	{`<http://a.example/s> <http://a.example/p1> <http://a.example/o1>;; .`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p1"),
			Obj:  IRI("http://a.example/o1"),
...
`, "", nil},
	...
	{`<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o"),
		},
	}},
...
<http://www.w3.org/2013/TurtleTests/\u0053> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> .`, "", []rdfTriple{
	...
	{`# x53 is capital S
<http://www.w3.org/2013/TurtleTests/\U00000053> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/S"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o"),
	...
	{`# RdfIRI with all chars in it.
<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p>
<scheme:!$%25&'()*+,-./0123456789:/@ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz~?#> .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("scheme:!$%25&'()*+,-./0123456789:/@ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz~?#"),
		},
	}},
...
:s :p :123 .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/123"),
		},
	}},
...
:s :p :%20 .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/%20"),
		},
	}},
...
: : : .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/"),
		},
	}},
...
:a:b:c  x:d:e:f :::: .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/a:b:c"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/d:e:f"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/:::"),
		},
	}},
...
@prefix x: <http://www.w3.org/2013/TurtleTests/> .
x:_  x:p_1 x:o .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/_"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p_1"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o"),
		},
	}},
...
@prefix : <http://www.w3.org/2013/TurtleTests/> .
@prefix x: <http://www.w3.org/2013/TurtleTests/> .
:a%3E  x:%25 :a%3Eb .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/a%3E"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/%25"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/a%3Eb"),
		},
	}},
	...
	{`<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> "string" .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  rdfTypeLiteral{str: "string", DataType: xsdString},
		},
	}},
	...
	{`<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> "string"@en .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  rdfTypeLiteral{str: "string", DataType: rdfLangString, lang: "en"},
		},
	}},
	...
	{`<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> "string"@en-uk .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  rdfTypeLiteral{str: "string", DataType: rdfLangString, lang: "en-uk"},
		},
	}},
	...
	{`<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> """abc""def''ghi""" .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  rdfTypeLiteral{str: `abc""def''ghi`, DataType: xsdString},
		},
	}},
...
def'''@en .`, "", []rdfTriple{
	...
	{`<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> "a\u0020b" .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  rdfTypeLiteral{str: "a b", DataType: xsdString},
		},
	}},
	...
	{`<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> "a\U00000020b" .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  rdfTypeLiteral{str: "a b", DataType: xsdString},
...
:s :p :\~\.-\!\$\&\'\(\)\*\+\,\;\=\/\?\#\@\_\%AA .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/~.-!$&'()*+,;=/?#@_%AA"),
		},
	}},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s :p :0123\~\.-\!\$\&\'\(\)\*\+\,\;\=\/\?\#\@\_\%AA123 .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/0123~.-!$&'()*+,;=/?#@_%AA123"),
		},
	}},
...
:xyz\~ :abc\.:  : .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/xyz~"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/abc.:"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/"),
		},
	}},
...
:s :p [ :q :o ] .`, "", []rdfTriple{
		...
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/2013/TurtleTests/q"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o"),
		},
	}},
...
:s :p [ :q1 :o1 ; :q2 :o2 ] .`, "", []rdfTriple{
		...
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/2013/TurtleTests/q1"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o1"),
		},
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/2013/TurtleTests/q2"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o2"),
		},
	}},
...
:s :p :o  .`, "", []rdfTriple{
		...
		},
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/2"),
		},
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
...
:s2 :p :o .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s1"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o"),
		},
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p1"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o1"),
		},
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p2"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o2"),
		},
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s2"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o"),
		},
	}},
	...
	{`<s> <p> 123 .`, "", []rdfTriple{
		{
			Subj: IRI("s"),
			Pred: IRI("p"),
			Obj:  rdfTypeLiteral{str: "123", DataType: xsdInteger},
		},
	}},
...
<s> <p> 123.0 . `, "", []rdfTriple{
		{
			Subj: IRI("s"),
			Pred: IRI("p"),
			Obj:  rdfTypeLiteral{str: "123.0", DataType: xsdDecimal},
		},
	}},
...
<s> <p> .1 . `, "", []rdfTriple{
		{
			Subj: IRI("s"),
			Pred: IRI("p"),
			Obj:  rdfTypeLiteral{str: ".1", DataType: xsdDecimal},
		},
	}},
...
<s> <p> 123.`, "", []rdfTriple{
	...
	{`<s> <p> 123.0e1 .`, "", []rdfTriple{
		{
			Subj: IRI("s"),
			Pred: IRI("p"),
			Obj:  rdfTypeLiteral{str: "123.0e1", DataType: xsdDouble},
		},
	}},
	...
	{`<s> <p> -123e-1 .`, "", []rdfTriple{
		{
			Subj: IRI("s"),
			Pred: IRI("p"),
			Obj:  rdfTypeLiteral{str: "-123e-1", DataType: xsdDouble},
		},
	}},
	...
	{`<s> <p> 123.E+1 .`, "", []rdfTriple{
		{
			Subj: IRI("s"),
			Pred: IRI("p"),
			Obj:  rdfTypeLiteral{str: "123.E+1", DataType: xsdDouble},
		},
	}},
	...
	{`@prefix xsd:     <http://www.w3.org/2001/XMLSchema#> .
<s> <p> "123"^^xsd:byte .`, "", []rdfTriple{
		{
			Subj: IRI("s"),
			Pred: IRI("p"),
			Obj:  rdfTypeLiteral{str: "123", DataType: xsdByte},
		},
	}},
	...
	{`@prefix rdf:     <http://www.w3.org/1999/02/22-rdf-syntax-ns#> .
@prefix xsd:     <http://www.w3.org/2001/XMLSchema#> .
<s> <p> "123"^^xsd:string .`, "", []rdfTriple{
		{
			Subj: IRI("s"),
			Pred: IRI("p"),
			Obj:  rdfTypeLiteral{str: "123", DataType: xsdString},
		},
	}},
...
:s a :C .`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s"),
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/C"),
		},
	}},
...
:s :p (1 "2" :o) .`, "", []rdfTriple{
		...
		},
		{
			Subj: rdfTypeBlank{id: "_:b2"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  rdfTypeLiteral{str: "2", DataType: xsdString},
		},
		{
			Subj: rdfTypeBlank{id: "_:b2"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest"),
...
(1 2 (1 2)) :p (( "a") "b" :o) .`, "", []rdfTriple{
		...
		},
		{
			Subj: rdfTypeBlank{id: "_:b3"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  rdfTypeBlank{id: "_:b4"},
		},
		{
			Subj: rdfTypeBlank{id: "_:b4"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  rdfTypeLiteral{str: "1", DataType: xsdInteger},
		},
		{
			Subj: rdfTypeBlank{id: "_:b4"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest"),
			Obj:  rdfTypeBlank{id: "_:b5"},
		},
		{
			Subj: rdfTypeBlank{id: "_:b5"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  rdfTypeLiteral{str: "2", DataType: xsdInteger},
		},
		{
		...
		},
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  rdfTypeBlank{id: "_:b6"},
		},
		{
			Subj: rdfTypeBlank{id: "_:b6"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  rdfTypeBlank{id: "_:b7"},
		},
		{
			Subj: rdfTypeBlank{id: "_:b7"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  rdfTypeLiteral{str: "a", DataType: xsdString},
		},
		{
			Subj: rdfTypeBlank{id: "_:b7"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest"),
		...
		},
		{
			Subj: rdfTypeBlank{id: "_:b6"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest"),
			Obj:  rdfTypeBlank{id: "_:b8"},
		},
		{
			Subj: rdfTypeBlank{id: "_:b8"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  rdfTypeLiteral{str: "b", DataType: xsdString},
		},
		{
			Subj: rdfTypeBlank{id: "_:b8"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest"),
			Obj:  rdfTypeBlank{id: "_:b9"},
		},
		{
			Subj: rdfTypeBlank{id: "_:b9"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o"),
		},
		{
	...
	//   rdfs:comment "Bad RdfIRI : space (negative test)" ;
	//   rdft:approval rdft:Approved ;
...
<http://www.w3.org/2013/TurtleTests/\/> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> .`,
		`bad RdfIRI: disallowed escape character '/'`,
		[]rdfTriple{},
	},
	...
	{`# No prefix
:s <http://www.w3.org/2013/TurtleTests/p> "x" .`, "missing namespace for prefix: ':'", []rdfTriple{}},
	...
	{`# No prefix
@prefix rdf:     <http://www.w3.org/1999/02/22-rdf-syntax-ns#> .
<http://www.w3.org/2013/TurtleTests/s> rdf:type :C .`, "missing namespace for prefix: ':'", []rdfTriple{}},

	//<#turtle-syntax-bad-prefix-03> rdf:type rdft:TestTurtleNegativeSyntax ;
	//   mf:name    "turtle-syntax-bad-prefix-03" ;
	//   rdfs:comment "@prefix without RdfIRI (negative test)" ;
	//   rdft:approval rdft:Approved ;
	//   mf:action    <turtle-syntax-bad-prefix-03.ttl> ;
	//   .

	{`# @prefix without RdfIRI.
@prefix ex: .`, "unexpected Dot as prefix RdfIRI", []rdfTriple{}},
...
@prefix <http://www.w3.org/2013/TurtleTests/> .`, "unexpected character: '<'", []rdfTriple{}},
	...
	{`# @prefix without :
@prefix x <http://www.w3.org/2013/TurtleTests/> .`, `illegal token: "x "`, []rdfTriple{}},

	//<#turtle-syntax-bad-base-01> rdf:type rdft:TestTurtleNegativeSyntax ;
	//   mf:name    "turtle-syntax-bad-base-01" ;
	//   rdfs:comment "@base without RdfIRI (negative test)" ;
	//   rdft:approval rdft:Approved ;
	//   mf:action    <turtle-syntax-bad-base-01.ttl> ;
	//   .

	{`# @base without RdfIRI.
@base .`, "unexpected Dot as base RdfIRI", []rdfTriple{}},
	...
	{`# @base in wrong case.
@BASE <http://www.w3.org/2013/TurtleTests/> .`, "unrecognized directive", []rdfTriple{}},
...
BASE <http://www.w3.org/2013/TurtleTests/> .
<s> <p> <o> .`, "unexpected Dot as subject", []rdfTriple{}},
...
<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> <http://www.w3.org/2013/TurtleTests/g> .`,
		"expected triple termination, got RdfIRI (absolute)",
		[]rdfTriple{},
	},
...
"hello" <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> .`,
		"unexpected RdfTypeLiteral as subject",
		[]rdfTriple{},
	},
...
<http://www.w3.org/2013/TurtleTests/s> "hello" <http://www.w3.org/2013/TurtleTests/o> .`,
		"unexpected RdfTypeLiteral as predicate",
		[]rdfTriple{},
	},
...
<http://www.w3.org/2013/TurtleTests/s> [] <http://www.w3.org/2013/TurtleTests/o> .`,
		"unexpected Anonymous blank node as predicate",
		[]rdfTriple{},
	},
...
<http://www.w3.org/2013/TurtleTests/s> _:p <http://www.w3.org/2013/TurtleTests/o> .`,
		"unexpected Blank node as predicate",
		[]rdfTriple{},
	},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s A :C .`, `illegal token: "A "`, []rdfTriple{}},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
a :p :o .`, "unexpected rdf:type as subject", []rdfTriple{}},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s :p a .`, "unexpected rdf:type as object", []rdfTriple{}},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
true :p :o .`, "unexpected RdfTypeLiteral (boolean shorthand syntax) as subject", []rdfTriple{}},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s true :o .`, "unexpected RdfTypeLiteral (boolean shorthand syntax) as predicate", []rdfTriple{}},
...
:a = :b .`, "unexpected character: '='", []rdfTriple{}},
...
:x.
  ns:p.
    ns:q :p :z .`, "unexpected Dot as predicate", []rdfTriple{}},
...
:x^ns:p :p :z .`, "syntax error: unexpected character: '^'", []rdfTriple{}},
...
:z is :p of :x .`, `illegal token: "is "`, []rdfTriple{}},
...
:a.:b.:c .`, "unexpected Dot as predicate", []rdfTriple{}},
...
@keywords a .
x a Item .`, "unrecognized directive", []rdfTriple{}},
...
x a Item .`, "unrecognized directive", []rdfTriple{}},
	...
	{`# => is not Turtle
@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s => :o .`, "unexpected character: '='", []rdfTriple{}},
	...
	{`# <= is not Turtle
@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s <= :o .`, "bad RdfIRI: disallowed character ' '", []rdfTriple{}},
...
@prefix : <http://www.w3.org/2013/TurtleTests/> .
@forSome :x .`, "unrecognized directive", []rdfTriple{}},
...
@prefix : <http://www.w3.org/2013/TurtleTests/> .
@forAll :x .`, "unrecognized directive", []rdfTriple{}},
...
x @a Item .`, "unrecognized directive", []rdfTriple{}},
...

	{
		`# No DOT
<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o>`,
		"expected triple termination, got EOF",
		[]rdfTriple{},
	},
...
<http://www.w3.org/2013/TurtleTests/s1> <http://www.w3.org/2013/TurtleTests/p1> <http://www.w3.org/2013/TurtleTests/o1> .`,
...

	{
		`# Trailing ;
<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> ;`,
		"expected triple termination, got Semicolon",
		[]rdfTriple{},
	},
...
<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> "string"@1 .`,
		"bad literal: invalid language tag",
		[]rdfTriple{},
	},
...
<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> "a\zb" .`,
		"bad literal: disallowed escape character 'z'",
		[]rdfTriple{},
	},
...
<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> "\uWXYZ" .`,
		"bad literal: insufficient hex digits in unicode escape",
		[]rdfTriple{},
	},
...
<http://www.w3.org/2013/TurtleTests/s> <http://www.w3.org/2013/TurtleTests/p> "\U0000WXYZ" .`,
	...
	{`# ~ must be escaped.
@prefix : <http://www.w3.org/2013/TurtleTests/> .
:a~b :p :o .`, "unexpected character: '~'", []rdfTriple{}},
	...
	{`# Bad %-sequence
@prefix : <http://www.w3.org/2013/TurtleTests/> .
:a%2 :p :o .`, "invalid hex escape sequence", []rdfTriple{}},
	...
	{`# No \u (x39 is "9")
@prefix : <http://www.w3.org/2013/TurtleTests/> .
:a\u0039 :p :o .`, "invalid escape character 'u'", []rdfTriple{}},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s :p "abc' .`, "bad literal: no closing quote: '\"'", []rdfTriple{}},
...
@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s :p """abc
def`, "bad literal: no closing quote: '\"'", []rdfTriple{}},
	...
	{`# Long literal with 4"
@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s :p """abc""""@en .`, "bad literal: no closing quote: '\"'", []rdfTriple{}},
...
:s :p '''abc''''@en .`, "bad literal: no closing quote: '\\''", []rdfTriple{}},
...

	{
		...
		"bad literal: illegal number syntax: missing exponent",
		[]rdfTriple{},
	},
...

	{
		...
		" bad literal: illegal number syntax (number followed by 'a')",
		[]rdfTriple{},
	},
...

	{
		...
		" bad literal: illegal number syntax (number followed by 'x')",
		[]rdfTriple{},
	},
...

	{
		...
		"bad literal: illegal number syntax: ('+' not followed by number)",
		[]rdfTriple{},
	},
...
:a a:a b:a .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/base1#a"),
			Pred: IRI("http://example.org/base1#b"),
			Obj:  IRI("http://example.org/base1#c"),
		},
		{
			Subj: IRI("http://example.org/base2#a"),
			Pred: IRI("http://example.org/base2#b"),
			Obj:  IRI("http://example.org/base2#c"),
		},
		{
			Subj: IRI("http://example.org/base1#a"),
			Pred: IRI("http://example.org/base2#a"),
			Obj:  IRI("http://example.org/base3#a"),
		},
	}},
...
:a :b :c,
      ...
      :e .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/base#a"),
			Pred: IRI("http://example.org/base#b"),
			Obj:  IRI("http://example.org/base#c"),
		},
		{
			Subj: IRI("http://example.org/base#a"),
			Pred: IRI("http://example.org/base#b"),
			Obj:  IRI("http://example.org/base#d"),
		},
		{
			Subj: IRI("http://example.org/base#a"),
			Pred: IRI("http://example.org/base#b"),
			Obj:  IRI("http://example.org/base#e"),
		},
	}},
...
:a :b :c ;
   ...
   :f :g .`, "", []rdfTriple{
		...
		{
			Subj: IRI("http://example.org/base#a"),
			Pred: IRI("http://example.org/base#d"),
			Obj:  IRI("http://example.org/base#e"),
		},
		{
			Subj: IRI("http://example.org/base#a"),
			Pred: IRI("http://example.org/base#f"),
			Obj:  IRI("http://example.org/base#g"),
		},
	}},
...
:c :d [] .`, "", []rdfTriple{
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://example.org/base#a"),
			Obj:  IRI("http://example.org/base#b"),
		},
		{
			Subj: IRI("http://example.org/base#c"),
			Pred: IRI("http://example.org/base#d"),
			Obj:  rdfTypeBlank{id: "_:b2"},
		},
	}},
...
:e :f [ :g :h ] .`, "", []rdfTriple{
		...
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://example.org/base#c"),
			Obj:  IRI("http://example.org/base#d"),
		},
		{
			Subj: IRI("http://example.org/base#e"),
			Pred: IRI("http://example.org/base#f"),
			Obj:  rdfTypeBlank{id: "_:b2"},
		},
		{
			Subj: rdfTypeBlank{id: "_:b2"},
			Pred: IRI("http://example.org/base#g"),
			Obj:  IRI("http://example.org/base#h"),
		},
	}},
...
`, "",
		[]rdfTriple{
			{
				Subj: IRI("http://example.org/stuff/1.0#a"),
				Pred: IRI("http://example.org/stuff/1.0#b"),
				Obj:  rdfTypeBlank{id: "_:b1"},
			},
			{
				Subj: rdfTypeBlank{id: "_:b1"},
				Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
				Obj:  rdfTypeLiteral{str: "apple", DataType: xsdString},
			},
			{
				Subj: rdfTypeBlank{id: "_:b1"},
				Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest"),
			...
			},
			{
				Subj: rdfTypeBlank{id: "_:b2"},
				Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first"),
				Obj:  rdfTypeLiteral{str: "banana", DataType: xsdString},
			},
			{
				Subj: rdfTypeBlank{id: "_:b2"},
				Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest"),
...
[] a owl:Restriction ;
  ...
  owl:maxCardinality 2 .`, "", []rdfTriple{
		{
			Subj: rdfTypeBlank{id: "_:hasParent"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),
			Obj:  IRI("http://www.w3.org/2002/07/owl#ObjectProperty"),
		},
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),
			Obj:  IRI("http://www.w3.org/2002/07/owl#Restriction"),
		},
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/2002/07/owl#onProperty"),
			Obj:  rdfTypeBlank{id: "_:hasParent"},
		},
		{
			Subj: rdfTypeBlank{id: "_:b1"},
			Pred: IRI("http://www.w3.org/2002/07/owl#maxCardinality"),
			Obj:  rdfTypeLiteral{str: "2", DataType: xsdInteger},
		},
	}},
...
<http://example.org/res5> <http://example.org/prop5> 4 .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/res1"),
			Pred: IRI("http://example.org/prop1"),
			Obj:  rdfTypeLiteral{str: "000000", DataType: xsdInteger},
		},
		{
			Subj: IRI("http://example.org/res2"),
			Pred: IRI("http://example.org/prop2"),
			Obj:  rdfTypeLiteral{str: "0", DataType: xsdInteger},
		},
		{
			Subj: IRI("http://example.org/res3"),
			Pred: IRI("http://example.org/prop3"),
			Obj:  rdfTypeLiteral{str: "000001", DataType: xsdInteger},
		},
		{
			Subj: IRI("http://example.org/res4"),
			Pred: IRI("http://example.org/prop4"),
			Obj:  rdfTypeLiteral{str: "2", DataType: xsdInteger},
		},
		{
			Subj: IRI("http://example.org/res5"),
			Pred: IRI("http://example.org/prop5"),
			Obj:  rdfTypeLiteral{str: "4", DataType: xsdInteger},
		},
	}},
...
ex4-:foo-bar ex4-:foo_bar "d" .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/ex1#foo-bar"),
			Pred: IRI("http://example.org/ex1#foo_bar"),
			Obj:  rdfTypeLiteral{str: "a", DataType: xsdString},
		},
		{
			Subj: IRI("http://example.org/ex2#foo-bar"),
			Pred: IRI("http://example.org/ex2#foo_bar"),
			Obj:  rdfTypeLiteral{str: "b", DataType: xsdString},
		},
		{
			Subj: IRI("http://example.org/ex3#foo-bar"),
			Pred: IRI("http://example.org/ex3#foo_bar"),
			Obj:  rdfTypeLiteral{str: "c", DataType: xsdString},
		},
		{
			Subj: IRI("http://example.org/ex4#foo-bar"),
			Pred: IRI("http://example.org/ex4#foo_bar"),
			Obj:  rdfTypeLiteral{str: "d", DataType: xsdString},
		},
	}},
...
ex:foo rdf:_2 "2" .
ex:foo :_abc "def" .
ex:foo :_345 "678" .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/ex#foo"),
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#_1"),
			Obj:  rdfTypeLiteral{str: "1", DataType: xsdString},
		},
		{
			Subj: IRI("http://example.org/ex#foo"),
			Pred: IRI("http://www.w3.org/1999/02/22-rdf-syntax-ns#_2"),
			Obj:  rdfTypeLiteral{str: "2", DataType: xsdString},
		},
		{
			Subj: IRI("http://example.org/ex#foo"),
			Pred: IRI("http://example.org/myprop#_abc"),
			Obj:  rdfTypeLiteral{str: "def", DataType: xsdString},
		},
		{
			Subj: IRI("http://example.org/ex#foo"),
			Pred: IRI("http://example.org/myprop#_345"),
			Obj:  rdfTypeLiteral{str: "678", DataType: xsdString},
		},
	}},
...
`, "",
		[]rdfTriple{
			{
				Subj: rdfTypeBlank{id: "_:b1"},
				Pred: IRI("http://example.org/ron"),
				Obj:  rdfTypeBlank{id: "_:b2"},
			},
			{
				Subj: IRI("http://example.org/ron"),
				Pred: IRI("http://example.org/ron"),
				Obj:  IRI("http://example.org/ron"),
			},
		},
	},
...
newlines""" .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/ex#a"),
			Pred: IRI("http://example.org/ex#b"),
			Obj:  rdfTypeLiteral{str: "a long\n\tliteral\nwith\nnewlines", DataType: xsdString},
		},
	}},
...
""" .`, "",
		[]rdfTriple{
			{
				Subj: IRI("http://example.org/foo#a"),
				Pred: IRI("http://example.org/foo#b"),
				Obj:  rdfTypeLiteral{str: "\nthis \ris a \U00012451long\t\nliteral\uABCD\n", DataType: xsdString},
			},
			{
				Subj: IRI("http://example.org/foo#d"),
				Pred: IRI("http://example.org/foo#e"),
				Obj:  rdfTypeLiteral{str: "\tThis \uABCDis\r \U00012451another\n\none\n", DataType: xsdString},
			},
		},
	},
...
`, "",
		[]rdfTriple{
			{
				Subj: IRI("http://example.org/#a"),
				Pred: IRI("http://example.org/#b"),
				Obj:  rdfTypeLiteral{str: "1.0", DataType: xsdDecimal},
			},
		},
	},
...
`, "",
		[]rdfTriple{
			...
			{
				Subj: IRI("http://example.org/#c"),
				Pred: IRI("http://example.org/#d"),
				Obj:  rdfTypeLiteral{str: "", DataType: xsdString},
			},
		},
	},
...
:e :f 1.0e0 .`, "", []rdfTriple{
		...
		{
			Subj: IRI("http://example.org#e"),
			Pred: IRI("http://example.org#f"),
			Obj:  rdfTypeLiteral{str: "1.0e0", DataType: xsdDouble},
		},
	}},
...
:e :f -1.0e0 .`, "", []rdfTriple{
	...
	{`# Test long literal
@prefix :  <http://example.org/ex#> .
:a :b """John said: "Hello World!\"""" .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/ex#a"),
			Pred: IRI("http://example.org/ex#b"),
			Obj:  rdfTypeLiteral{str: `John said: "Hello World!"`, DataType: xsdString},
		},
	}},
...
:k :l :m ; #ignore me
   :n :o ; # and me
   :p :q . # and me`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/#a"),
			Pred: IRI("http://example.org/#b"),
			Obj:  IRI("http://example.org/#c"),
		},
		{
			Subj: IRI("http://example.org/#d"),
			Pred: IRI("http://example.org/#e"),
			Obj:  IRI("http://example.org/#f"),
		},
		{
			Subj: IRI("http://example.org/#g"),
			Pred: IRI("http://example.org/#h"),
			Obj:  IRI("http://example.org/#i"),
		},
		{
			Subj: IRI("http://example.org/#g"),
			Pred: IRI("http://example.org/#h"),
			Obj:  IRI("http://example.org/#j"),
		},
		{
			Subj: IRI("http://example.org/#k"),
			Pred: IRI("http://example.org/#l"),
			Obj:  IRI("http://example.org/#m"),
		},
		{
			Subj: IRI("http://example.org/#k"),
			Pred: IRI("http://example.org/#n"),
			Obj:  IRI("http://example.org/#o"),
		},
		{
			Subj: IRI("http://example.org/#k"),
			Pred: IRI("http://example.org/#p"),
			Obj:  IRI("http://example.org/#q"),
		},
	}},
...
`, "",
		[]rdfTriple{
			{
				Subj: IRI("http://example.org/bar#blah"),
				Pred: IRI("http://example.org/bar#blah"),
				Obj:  IRI("http://example.org/bar#blah"),
			},
		},
	},
...
<http://example.org/foo> <http://example.org/bar> "1.2345678901234567890123457890"^^<http://www.w3.org/2001/XMLSchema#decimal> .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.345", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
		...
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "1.000000000", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.3", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.234000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.2340000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.23400000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.234000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.2340000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.23400000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.234000000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.2340000000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.23400000000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.234000000000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.2340000000000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.23400000000000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.234000000000000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.2340000000000000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "2.23400000000000000000005", DataType: xsdDecimal},
		},
		{
			Subj: IRI("http://example.org/foo"),
			Pred: IRI("http://example.org/bar"),
			Obj:  rdfTypeLiteral{str: "1.2345678901234567890123457890", DataType: xsdDecimal},
		},
	}},

	//<#turtle-subm-27> rdf:type rdft:TestTurtleEval ;
	//   mf:name    "turtle-subm-27" ;
	//   rdfs:comment "Repeating @base changes base for relative RdfIRI lookup" ;
	//   rdft:approval rdft:Approved ;
	//   mf:action    <turtle-subm-27.ttl> ;
	//   mf:result    <turtle-subm-27.nt> ;
	//   .

	{`# In-scope base RdfIRI is <http://www.w3.org/2013/TurtleTests/turtle-subm-27.ttl> at this point
<a1> <b1> <c1> .
@base <http://example.org/ns/> .
# In-scope base RdfIRI is http://example.org/ns/ at this point
<a2> <http://example.org/ns/b2> <c2> .
@base <foo/> .
# In-scope base RdfIRI is http://example.org/ns/foo/ at this point
<a3> <b3> <c3> .
@prefix : <bar#> .
:a4 :b4 :c4 .
...
:a5 :b5 :c5 .`, "", []rdfTriple{
		...
		{
			Subj: IRI("http://example.org/ns/a2"),
			Pred: IRI("http://example.org/ns/b2"),
			Obj:  IRI("http://example.org/ns/c2"),
		},
		{
			Subj: IRI("http://example.org/ns/foo/a3"),
			Pred: IRI("http://example.org/ns/foo/b3"),
			Obj:  IRI("http://example.org/ns/foo/c3"),
		},
		{
			Subj: IRI("http://example.org/ns/foo/bar#a4"),
			Pred: IRI("http://example.org/ns/foo/bar#b4"),
			Obj:  IRI("http://example.org/ns/foo/bar#c4"),
		},
		{
			Subj: IRI("http://example.org/ns2#a5"),
			Pred: IRI("http://example.org/ns2#b5"),
			Obj:  IRI("http://example.org/ns2#c5"),
		},
	}},

	//<#turtle-eval-bad-01> rdf:type rdft:TestTurtleNegativeEval ;
	//   mf:name    "turtle-eval-bad-01" ;
	//   rdfs:comment "Bad RdfIRI : good escape, bad charcater (negative evaluation test)" ;
	//   rdft:approval rdft:Approved ;
	//   mf:action    <turtle-eval-bad-01.ttl> ;
	//   .

	{
		`# Bad RdfIRI : good escape, bad charcater
<http://www.w3.org/2013/TurtleTests/\u0020> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> .`,
		`bad RdfIRI: disallowed character in unicode escape: "\\u0020"`,
		[]rdfTriple{},
	},

	//<#turtle-eval-bad-02> rdf:type rdft:TestTurtleNegativeEval ;
	//   mf:name    "turtle-eval-bad-02" ;
	//   rdfs:comment "Bad RdfIRI : hex 3C is < (negative evaluation test)" ;
	//   rdft:approval rdft:Approved ;
	//   mf:action    <turtle-eval-bad-02.ttl> ;
	//   .

	{
		`# Bad RdfIRI : hex 3C is <
<http://www.w3.org/2013/TurtleTests/\u003C> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> .`,
		`bad RdfIRI: disallowed character in unicode escape: "\\u003C"`,
		[]rdfTriple{},
	},
	...
	//   rdfs:comment "Bad RdfIRI : hex 3E is  (negative evaluation test)" ;
	//   rdft:approval rdft:Approved ;
	//   mf:action    <turtle-eval-bad-03.ttl> ;
	//   .

	{
		`# Bad RdfIRI : hex 3E is >
<http://www.w3.org/2013/TurtleTests/\u003E> <http://www.w3.org/2013/TurtleTests/p> <http://www.w3.org/2013/TurtleTests/o> .`,
		`bad RdfIRI: disallowed character in unicode escape: "\\u003E"`,
		[]rdfTriple{},
	},
	...
	//   rdfs:comment "Bad RdfIRI : {abc} (negative evaluation test)" ;
	//   rdft:approval rdft:Approved ;
...
.`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/o#numbersign"),
		},
	}},
...
.`, "", []rdfTriple{
		{
			Subj: IRI("http://a.example/s"),
			Pred: IRI("http://a.example/p"),
			Obj:  IRI("http://a.example/#numbersign"),
		},
	}},
...
:s :p1 """test-\\""" .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/ns#s"),
			Pred: IRI("http://example.org/ns#p1"),
			Obj:  rdfTypeLiteral{str: "test-\\", DataType: xsdString},
		},
	}},
...
:c :d """second long literal""" .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/ex#a"),
			Pred: IRI("http://example.org/ex#b"),
			Obj:  rdfTypeLiteral{str: "first long literal", DataType: xsdString},
		},
		{
			Subj: IRI("http://example.org/ex#c"),
			Pred: IRI("http://example.org/ex#d"),
			Obj:  rdfTypeLiteral{str: "second long literal", DataType: xsdString},
		},
	}},
...
@prefix :  <http://example.org/ex#> .
:a :b """Cheers"""@en-UK .`, "", []rdfTriple{
		{
			Subj: IRI("http://example.org/ex#a"),
			Pred: IRI("http://example.org/ex#b"),
			Obj:  rdfTypeLiteral{str: "Cheers", lang: "en-UK", DataType: rdfLangString},
		},
	}},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
_:b1. :p :o .`, "unexpected Dot as predicate", []rdfTriple{}},
...
:s
	:p [
		:p1 27.
	] .`, "unexpected Property list end as object", []rdfTriple{}},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s :p :-o .`, "unexpected character: '-'", []rdfTriple{}},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s :p :o%2 .`, "invalid hex escape sequence", []rdfTriple{}},
	...
	{`@prefix : <http://www.w3.org/2013/TurtleTests/> .
:s :p :%2o .`, "invalid hex escape sequence", []rdfTriple{}},
...
eg.:s eg.:p eg.:o .`, "illegal token: \"eg. \"", []rdfTriple{}},
	...
	{`@prefix .eg : <http://www.w3.org/2013/TurtleTests/> .
.eg:s .eg:p .eg:o .`, "unexpected character: '.'", []rdfTriple{}},
...

	{
		...
		"missing namespace for prefix: 'valid'",
		[]rdfTriple{},
	},
...
:3.s :3.p :3.`, "", []rdfTriple{
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s.1"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p.1"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o.1"),
		},
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/s..2"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p..2"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o..2"),
		},
		{
			Subj: IRI("http://www.w3.org/2013/TurtleTests/3.s"),
			Pred: IRI("http://www.w3.org/2013/TurtleTests/3.p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/3"),
		},
	}},
...
_:b.0 :p :o . # Contains dot, ends with digit`, "", []rdfTriple{
		{
			Subj: rdfTypeBlank{id: "_:0b"},
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o"),
		},
		{
			Subj: rdfTypeBlank{id: "_:_b"},
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o"),
		},
		{
			Subj: rdfTypeBlank{id: "_:b.0"},
			Pred: IRI("http://www.w3.org/2013/TurtleTests/p"),
			Obj:  IRI("http://www.w3.org/2013/TurtleTests/o"),
		},
	}},
