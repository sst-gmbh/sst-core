...
// readRune is utf8.DecodeRune from the standard library, except it uses a different
...
// The idea and implementation of the custom readRune function is lifted from
...
func readRune(s []byte) (r rune, size int) {
	n := len(s)
	if n < 1 {
		return 0, 0
	}
