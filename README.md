...
SST-Core is available under either a commercial licenses or under the [POLYFORM Noncommercial 1.0.0 license](https://polyformproject.org/licenses/noncommercial/1.0.0)

Key point: The **PolyForm Noncommercial 1.0.0** license prohibits any commercial use, which means:
* SST-Core **is not** <ins>Open Source™</ins> by OSI definition
* SST-Core **is not** <ins>free software</ins> by FSF definition
* SST-Core **is** <ins>source-available</ins> with a usage restriction
